                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <form class="form-group">
                                    ...
                                    <label for="isDisplay" class="col-sm-1 control-label">是否可用</label>
                                    <div class="col-sm-3">
...
<script type="text/javascript">
    ...
    $('#add').click(function () {
        //跳转到品牌新增页面   另外一种方式:写<a>跳转  ？如果要做权限判断,用超链接就不好控制
        window.location.href = "/brand/toAdd";
    });
    ...
    $('#edit').click(function () {
        ...
        if (l == 0 || l > 1) {
            ...
            window.location.href = "/toUpdate?id=" + selections[0]
        }
    });
    ...
    $remove.click(function () {
        layer.confirm('确定删除', {icon: 3, title: '提示'}, function () {
            $.post('/brand/del', {ids: selections.join()}, function (data) {
                if (data.success) {
                    //刷新表格
                    layer.msg('删除成功', {icon: 1});
                    $table.bootstrapTable('refresh');
                } else {
                    layer.alert("记录正被使用!", {icon: 2})
                }
            });
        });
