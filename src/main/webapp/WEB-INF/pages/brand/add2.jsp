...
<head>
    ...
    <link rel="stylesheet" href="/res/bootstrapValidator/css/bootstrapValidator.css"/>
    <!-- text fonts -->
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-body">
                            <div class="widget-main no-padding">
                                <form class="form-horizontal" role="form" id="myform" action="/brand/add"
                                      method="post">
                                    <div class="space-4"></div>
                                    <div class="form-group">
                                        <label for="name" class="col-sm-1 control-label">品牌名称</label>
                                        <div class="col-sm-11">
                                            <input type="text" class="form-control" id="name" name="name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="description" class="col-sm-1 control-label">品牌描述</label>
                                        <div class="col-sm-11">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-11">
                                            <div class="radio">
                                                <label>
                                                    <input name="isDisplay" type="radio" class="ace" value="1" checked/>
                                                    <span class="lbl"> 可用</span>
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                                    <input name="isDisplay" type="radio" class="ace" value="0"/>
...
<script src="/res/bootstrapValidator/js/bootstrapValidator.js"></script>
<script src="/res/bootstrapValidator/js/language/zh_CN.js"></script>
<!--[if lte IE 8]>
