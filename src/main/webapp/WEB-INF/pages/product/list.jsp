            ...
            <div class="page-content">
                ...
                <div class="row">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <form class="form-group">
                                    ...
                                    <label for="isShow" class="col-sm-1 control-label">上下架</label>
                                    <div class="col-sm-2">
                                    ...
                                    <label for="brandId" class="col-sm-1 control-label">品牌</label>
                                    <div class="col-sm-2">
                    ...
                    <div id="toolbar" class="btn-group">
                        ...
                        <button type="button" class="btn btn-primary btn-sm" id="up">
                            <i class="glyphicon glyphicon-upload"></i>上架
                        </button>
                        <button type="button" class="btn btn-primary btn-sm" id="down">
                            <i class="glyphicon glyphicon-download"></i>下架
                        </button>
                        <button type="button" class="btn btn-primary btn-sm" id="stock">
                            <i class="glyphicon glyphicon-edit"></i>库存管理
                        </button>
                        <button type="button" class="btn btn-primary btn-sm" id="pic">
                            <i class="glyphicon glyphicon-edit"></i>商品图片
                        </button>
...
<script src="/res/bootstrap-table/locale/bootstrap-table-zh-CN.js"></script>
...
<script type="text/javascript">
    ...
    $('#edit').click(function () {
        ...
        if (l == 0 || l > 1) {
            ...
            window.location.href = "/back/product/toUpdate?id=" + selections[0]
        }
    });
