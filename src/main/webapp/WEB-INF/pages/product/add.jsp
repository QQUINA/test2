...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/res/webuploader/image-upload/style.css">
    <!-- text fonts -->
            ...
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    <li>
                        ...
                        <a href="/back/emp/toWelcome">首页</a>
                    </li>
                    <li>
...
<script type="text/javascript" src="/res/webuploader/image-upload/upload.js"></script>
